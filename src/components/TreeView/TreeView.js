...
treeviewSpanIndentStyle["marginLeft"] = "50px";
treeviewSpanIndentStyle["marginRight"] = "10px";


let treeviewSpanTextStyle = treeviewSpanStyle;
//treeviewSpanTextStyle["width"] = "100px";



let treeviewSpanIconStyle = treeviewSpanStyle;
treeviewSpanIconStyle["marginLeft"] = "10px";
treeviewSpanIconStyle["marginRight"] = "10px";
...
// unselectedIcon: 'glyphicon glyphicon-unchecked',
  unselectedIcon: 'glyphicon glyphicon-option-vertical',
 ...
 /* toggleSelected(event) {
  ...
  render() {
    ...
    let nodeIcon = (node.icon || options.nodeIcon) ? (
        <span className={'icon'} onClick={this.openSubmenu} style={treeviewSpanIconStyle}> <i   //Changes done by jagat
    ...
    if (options.enableLinks) {
      ...
      nodeText = (
        ...
        //<span style={treeviewSpanStyle}> {node.v_ename} </span>
      )     
    }
    ...
    console.log("indents");
    console.log(indents);
    console.log("expandCollapseIcon");
    console.log(expandCollapseIcon);
